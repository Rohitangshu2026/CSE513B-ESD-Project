...
const OrgForm: React.FC<Props> = ({ form, setForm, onSubmit, submitText }) => {
  ...
  return (
    ...
    >
      ...
      {/* HR Contact */}
      {/* <h3 style={styles.sectionTitle}>HR Contact</h3>
      <div style={styles.row}>
        <input
          style={styles.input}
          ...
          onChange={(e) =>
            setForm({
              ...form,
              hrContacts: [{ ...hr, firstName: e.target.value }],
            })
          }
        />
        <input
          ...
          onChange={(e) =>
            setForm({
              ...form,
              hrContacts: [{ ...hr, lastName: e.target.value }],
            })
          }
        />
      </div>
      ...
      <div style={styles.row}>
        <input
          ...
          onChange={(e) =>
            setForm({
              ...form,
              hrContacts: [{ ...hr, email: e.target.value }],
            })
          }
        />
        <input
          ...
          onChange={(e) =>
            setForm({
              ...form,
              //hrContacts: [{ ...hr, contactNumber: e.target.value }],
            })
          }
        />
      </div>
      ...
      <input
        ...
        onChange={(e) =>
          setForm({
            ...form,
            //hrContacts: [{ ...hr, designation: e.target.value }],
          })
        }
      /> */}
